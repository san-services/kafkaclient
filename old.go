...
func NewOld(server string, groupID string, onMessageReceived onMessage) *KafkaClientOld {
	return &KafkaClientOld{
		Server:            server,
		GroupID:           groupID,
...
func (kc *KafkaClientOld) ProduceToTopic(ctx context.Context, topic string, message string) error {
...
func (kc *KafkaClientOld) ListenToTopic(ctx context.Context, topic string) {
